...
if (len(sys.argv)>1):
    ...
    start_location=raw_input("Enter path of pre-cert package")
...
#Folder tree 
path={'yt_precert' : pkgpath, 'yts_precert': pkgpath+"/YTS", 'yts_man_precert': pkgpath+"/YTS/Manual/", 'yts_man_DRM_precert' : pkgpath+"/YTS/Manual/DRM/", 'yts_man_DPBR_precert' : pkgpath+"/YTS/Manual/Dynamic_playbackRate/", 'yts_man_IPBR_precert' : pkgpath+"/YTS/Manual/Initial_playbackRate/", 'yts_man_webp_precert' : pkgpath+"/YTS/Manual/Webp/", 'yts_man_webgl_precert': pkgpath+"YTS/Manual/webgl/", 'yts_man_cobaltm2m_precert' : pkgpath+"/YTS/Manual/cobalt_map_to_mesh", 'yts_auto_precert' : pkgpath+"/YTS/Automated/", 'yt_dial_precert' : pkgpath+"/DIAL/", 'yt_misc_precert' : pkgpath+"/Misc/", 'yt_app_precert' : pkgpath+"/YouTube_Application", 'yt_app_lang_precert' : pkgpath+"/YouTube_Application/Language/", 'yt_app_perf_precert' : pkgpath+"/YouTube_Application/Performance/", 'yt_app_speech_precert' : pkgpath+"/YouTube_Application/Speech/"}
